...
#define RndSeed (*(GUEST<HIDDENONGINT> *)(0x156 + ROMlib_offset))
...
#define Ticks (*(GUEST<HIDDENONGINT> *)(0x16A + ROMlib_offset))
...
#define GZRootHnd (*(GUEST<HIDDENandle> *)(0x328 + ROMlib_offset))
...
#define WidthListHand (*(GUEST<HIDDENandle> *)(0x8E4 + ROMlib_offset))
...
#define ScrapHandle (*(GUEST<HIDDENandle> *)(0x964 + ROMlib_offset))
...
#define ROMFont0 (*(GUEST<HIDDENandle> *)(0x980 + ROMlib_offset))
...
#define MenuList (*(GUEST<HIDDENandle> *)(0xA1C + ROMlib_offset))
...
#define TopMapHndl (*(GUEST<HIDDENandle> *)(0xA50 + ROMlib_offset))
#define SysMapHndl (*(GUEST<HIDDENandle> *)(0xA54 + ROMlib_offset))
...
#define DAStrings (*(GUEST<HIDDENandle> (*)[4])(0xAA0 + ROMlib_offset))
#define TEScrpLength (*(GUEST<INTEGER> *)(0xAB0 + ROMlib_offset))
#define TEScrpHandle (*(GUEST<HIDDENandle> *)(0xAB4 + ROMlib_offset))
#define AppPacks (*(GUEST<HIDDENandle> (*)[8])(0xAB8 + ROMlib_offset))
#define SysResName (*(GUEST<Byte> (*)[20])(0xAD8 + ROMlib_offset))
#define AppParmHandle (*(GUEST<HIDDENandle> *)(0xAEC + ROMlib_offset))
...
#define MBDFHndl (*(GUEST<HIDDENandle> *)(0xB58 + ROMlib_offset))
#define MBSaveLoc (*(GUEST<HIDDENandle> *)(0xB5C + ROMlib_offset))
...
#define SynListHandle (*(GUEST<HIDDENandle> *)(0xD32 + ROMlib_offset))
