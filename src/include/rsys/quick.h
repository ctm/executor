 ...
 * All rights reserved.
 *
 * $Id: quick.h 63 2004-12-24 18:19:43Z ctm $
 */
...
typedef enum { text_helper_draw, text_helper_measure } text_helper_action_t;

extern LONGINT text_helper (LONGINT n, Ptr textbufp, Point *nump, Point *denp,
...
#define CALLTEXT(arg1, arg2, arg3, arg4)				\
    (thePort->grafProcs ?						\
        ((*(void (*)())thePort->grafProcs->textProc)((arg1), (arg2),	\
						    (arg3), (arg4)), 0)	\
    :									\
...
#define CALLLINE(arg1)							\
    (thePort->grafProcs ?						\
        ((*(void (*)())thePort->grafProcs->lineProc)((arg1)), 0)	\
    :									\
        (StdLine((arg1)), 0))

#define CALLRECT(arg1, arg2)						\
    (thePort->grafProcs ?						\
        ((*(void (*)())thePort->grafProcs->rectProc)((arg1), (arg2)), 0)\
    :									\
        (StdRect((arg1), (arg2)), 0))

#define CALLOVAL(arg1, arg2)						\
    (thePort->grafProcs ?						\
        ((*(void (*)())thePort->grafProcs->ovalProc)((arg1), (arg2)), 0)\
    :									\
        (StdOval((arg1), (arg2)), 0))

#define CALLRRECT(arg1, arg2, arg3, arg4)				\
    (thePort->grafProcs ?						\
        ((*(void (*)())thePort->grafProcs->rRectProc)((arg1), (arg2),	\
						    (arg3), (arg4)), 0) \
    :									\
...
#define CALLARC(arg1, arg2, arg3, arg4)					\
    (thePort->grafProcs ?						\
        ((*(void (*)())thePort->grafProcs->arcProc)((arg1), (arg2),	\
						    (arg3), (arg4)), 0) \
    :									\
...
#define CALLRGN(arg1, arg2)						\
    (thePort->grafProcs ?						\
        ((*(void (*)())thePort->grafProcs->rgnProc)((arg1), (arg2)), 0)	\
    :									\
        (StdRgn((arg1), (arg2)), 0))

#define CALLPOLY(arg1, arg2)						\
    (thePort->grafProcs ?						\
        ((*(void (*)())thePort->grafProcs->polyProc)((arg1), (arg2)), 0)\
    :									\
        (StdPoly((arg1), (arg2)), 0))

#define CALLBITS(arg1, arg2, arg3, arg4, arg5)				\
    (thePort->grafProcs ?						\
        ((*(void (*)())thePort->grafProcs->bitsProc)((arg1), (arg2),	\
					    (arg3), (arg4), (arg5)), 0)	\
    :									\
...
#define CALLCOMMENT(arg1, arg2, arg3)					\
    (thePort->grafProcs ?						\
        ((*(void (*)())thePort->grafProcs->commentProc)((arg1), (arg2),	\
							   (arg3)), 0)	\
    :									\
...
#define CALLTXMEAS(arg1, arg2, arg3, arg4, arg5)			\
    (thePort->grafProcs ?						\
        (*(INTEGER (*)())thePort->grafProcs->txMeasProc)((arg1), (arg2),\
					    (arg3),	(arg4), (arg5))	\
    :									\
...
#define PICWRITE(addr, count)						\
    (thePort->grafProcs ?						\
        ((*(void (*)())thePort->grafProcs->putPicProc)((Ptr) (addr),	\
						(INTEGER) (count)), 0)	\
    :									\
...
extern INTEGER ROMlib_CALLTXMEAS (INTEGER bc, Ptr bufp, Point *nump,
				  Point *denp, FontInfo *fip);
