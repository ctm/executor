...
void
Executor::str255_from_c_string (Str255 str255, const char *c_stringp)
{
  int len;
...
void
Executor::str63assign (Str63 new1, const StringPtr old)
{
  strNassign (new1, old, 63);
}

void
Executor::str31assign (Str63 new1, const StringPtr old)
{
