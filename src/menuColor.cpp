...
void
Executor::menu_bar_color (RGBColor *bar_color)
{
  MCEntryPtr mc_entry;
...
void
Executor::menu_title_color (int16 id, RGBColor *title_color)
{
  MCEntryPtr mc_entry;
...
void
Executor::menu_bk_color (int16 id, RGBColor *bk_color)
{
  MCEntryPtr mc_entry;
...
void
Executor::menu_item_colors (int16 id, int16 item,
