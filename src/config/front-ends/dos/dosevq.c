 ...
 */
void dosevq_enqueue(dosevq_type_t type, unsigned char which,
 ...
 * interrupt(s).
 */
void dosevq_note_mouse_interrupt(void)
{
    if(mouse_handler_and_queue_sel != 0)
    {
        int pending;
