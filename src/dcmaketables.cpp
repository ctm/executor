...
char ROMlib_rcsid_dcmaketables[] = "$Id: dcmaketables.c 63 2004-12-24 18:19:43Z ctm $";
#endif
                                ...
                                const rgb_spec_t *src_rgb_spec)
{
    ...
    if(src_rgb_spec->bpp == 16)
        ...
        {
            case 1:
                return depthconv_16_1;
            case 2:
                return depthconv_16_2;
            case 4:
                return depthconv_16_4;
            case 8:
                return depthconv_16_8;
        }
    else if(src_rgb_spec->bpp == 32)
        switch(out_bpp)
        {
            case 1:
                return depthconv_32_1;
            case 2:
                return depthconv_32_2;
            case 4:
                return depthconv_32_4;
            case 8:
                return depthconv_32_8;
        }
