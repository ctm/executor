 ...
 */
bool msdos_test_max_files(void)
{
...
Fatal error: FILES= parameter in CONFIG.SYS is too small.  We recommend
              FILES
              = 30(or more).To fix this,
              edit your CONFIG.SYS file(usually
                                            C
                                        :\\CONFIG.SYS),
              ...
              FILES = 20
                  ...
                  (it may not be exactly 20) and change the number to 30
                  or more.If the
                         FILES
              = value is already greater than 30 and you still get this message,
              you may need to make it even larger.You can use the \"-nofilescheck\"
                  command line switch to skip this check
