...
int _crt0_startup_flags = _CRT0_FLAG_PRESERVE_UPPER_CASE | _CRT0_FLAG_NULLOK | _CRT0_FLAG_UNIX_SBRK;
...
void switch_to_non_moving_sbrk(void)
{
 ...
 */
bool msdos_check_memory_remaining(unsigned long desired_bytes)
{
