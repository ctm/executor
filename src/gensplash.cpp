...
char ROMlib_rcsid_gensplash[] = "$Id: gensplash.c 63 2004-12-24 18:19:43Z ctm $";
#endif
...
uint8 color_pixel(struct splash_screen_color *color)
{
    int i;
...
void ppm_read_write_bits(int height, int width, int row_bytes,
                         FILE *fp, uint8 *bits)
{
    int max_cmp_value;
    uint8 *dst;
