...
void
Executor::te_char_to_point (const TEPtr tep, int16 sel, Point *p)
{
  SignedByte hText_flags;
  Handle hText;
  Ptr Text;
...
void
Executor::ROMlib_togglelite (TEHandle te)
{
  int16 state;
...
void
Executor::ROMlib_tesave (tesave *t, TEHandle teh)
{
  TEPtr tp;
...
void
Executor::ROMlib_terestore (tesave *t)
{
