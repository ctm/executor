...
osstuff_t Executor::osstuff[0x100] = {
    ...
    {0,0},//    { 0, (void *)_CompactMem },
    {0,0},//    { 0, (void *)_PurgeMem },
    { 0, (void *)_AddDrive },
    ...
    { 0, (void *)_HFSDispatch },
    {0,0},//    { 0, (void *)_MaxBlock },
    {0,0},//    { 0, (void *)_PurgeSpace },
    {0,0},//    { 0, (void *)_MaxApplZone },
    {0,0},//    { 0, (void *)_MoveHHi },
    {0,0},//    { 0, (void *)_StackSpace },
    {0,0},//    { 0, (void *)_NewEmptyHandle },
