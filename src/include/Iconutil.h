...
extern OSErr C_PlotIconID(const Rect *rect,
                                      ...
                                      short res_id);
PASCAL_SUBTRAP(PlotIconID, 0xABC9, IconDispatch);
...
extern OSErr C_PlotIconMethod(const Rect *rect,
                                          ...
                                          void *data);
PASCAL_SUBTRAP(PlotIconMethod, 0xABC9, IconDispatch);
...
extern OSErr C_PlotIconHandle(const Rect *rect,
                                          ...
                                          IconTransformType transform,
                                          Handle icon);
PASCAL_SUBTRAP(PlotIconHandle, 0xABC9, IconDispatch);
extern OSErr C_PlotCIconHandle(const Rect *rect,
                                           IconAlignmentType align,
                                           IconTransformType transform,
                                           CIconHandle icon);
PASCAL_SUBTRAP(PlotCIconHandle, 0xABC9, IconDispatch);
extern OSErr C_PlotSICNHandle(const Rect *rect,
                                          IconAlignmentType align,
                                          IconTransformType transform,
                                          Handle icon);
PASCAL_SUBTRAP(PlotSICNHandle, 0xABC9, IconDispatch);
