...
void Executor::C_FillCRoundRect(const Rect *r, short ovalWidth,
                                short ovalHeight, PixPatHandle pixpat)
{
    FillCxxx(CALLRRECT(fill, (Rect *)r, ovalWidth, ovalHeight));
}

void Executor::C_FillCOval(const Rect *r, PixPatHandle pixpat)
{
    FillCxxx(CALLOVAL(fill, (Rect *)r));
}

void Executor::C_FillCArc(const Rect *r, short startAngle, short arcAngle,
                          PixPatHandle pixpat)
{
    FillCxxx(CALLARC(fill, (Rect *)r, startAngle, arcAngle));
}

void Executor::C_FillCPoly(PolyHandle poly, PixPatHandle pixpat)
{
    FillCxxx(CALLPOLY(fill, poly));
}

void Executor::C_FillCRgn(RgnHandle rgn, PixPatHandle pixpat)
{
