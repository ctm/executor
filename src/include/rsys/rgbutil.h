...
typedef struct rgb_spec
{
    ...
    uint32_t xor_mask; /* Bits XOR'd after RGB assembled.  */
   ...
   */
    uint32_t black_pixel; /* Tiled to 32 bits. 		    */
    uint32_t white_pixel; /* Tiled to 32 bits. 		    */
    uint32_t pixel_bits_mask; /* Tiled to 32 bits. 		    */
