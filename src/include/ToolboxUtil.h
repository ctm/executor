...
extern pascal trap Fract P_FracSqrt(Fract x);
extern pascal trap Fract C_FracSin(Fixed x);
extern pascal trap Fract P_FracSin(Fixed x);
extern Fixed FixATan2(LONGINT x, LONGINT y);
extern pascal trap Fixed C_FixAtan2(LONGINT x, LONGINT y);
extern pascal trap Fixed P_FixAtan2(LONGINT x, LONGINT y);
extern pascal trap Fract C_FracCos(Fixed x);
extern pascal trap Fract P_FracCos(Fixed x);
extern pascal trap Fixed C_FixRatio(INTEGER n, INTEGER d);
extern pascal trap Fixed P_FixRatio(INTEGER n, INTEGER d);
extern pascal trap Fixed C_FixMul(Fixed a, Fixed b);
extern pascal trap Fixed P_FixMul(Fixed a, Fixed b);
extern pascal trap INTEGER C_FixRound(Fixed x);
extern pascal trap INTEGER P_FixRound(Fixed x);
extern pascal trap StringHandle C_NewString(StringPtr s);
extern pascal trap StringHandle P_NewString(StringPtr s);
extern pascal trap void C_SetString(StringHandle h, StringPtr s);
extern pascal trap void P_SetString(StringHandle h, StringPtr s);
extern pascal trap StringHandle C_GetString(INTEGER i);
extern pascal trap StringHandle P_GetString(INTEGER i);
