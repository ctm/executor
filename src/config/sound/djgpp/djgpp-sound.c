...
char ROMlib_rcsid_djgpp_sound[] = "$Id: djgpp-sound.c 63 2004-12-24 18:19:43Z ctm $";
#endif
...
void sound_djgpp_note_sound_interrupt(void)
{
...
bool sound_djgpp_init(sound_driver_t *s)
{
